...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    // In Moodle-mt only admins and cli calls can set some delicate settings (eg.: opentogoogle)
    ...
    // In Moodle-mt only admins and cli calls can set some delicate settings (eg.: extendedusernamechars)
    if (is_siteadmin() || (isset($isclicall) && $isclicall)) {
    ...
    // In Moodle-mt only admins and cli calls can set some delicate settings (eg.: cronclionly, cronremotepassword)
    if (is_siteadmin() || (isset($isclicall) && $isclicall)) {
